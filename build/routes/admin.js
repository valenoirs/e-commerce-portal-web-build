...
exports.router.post("/signin", admin.signIn);
exports.router.post("/signup", upload.fields([
    { name: "pirt", maxCount: 1 },
    { name: "halal", maxCount: 1 },
]), admin.signUp);
exports.router.get("/signout", admin.signOut);
exports.router.put("/", admin.updateAdmin);
exports.router.get("/", admin.readAdmin);
